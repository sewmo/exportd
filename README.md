...
Your database then periodically scrapes the HTTP endpoint for metric updates. The project was designed with the Prometheus time-series database in mind.  
